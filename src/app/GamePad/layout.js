  ...
  return (
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <Button startIcon={<GamepadIcon />} onClick={()=>router.push("/GamePad")}>Game Pad</Button>
        <Divider  color="white"/>
        <br/><br/>
        <Divider color="white"/>
        <Button startIcon={<PhoneAndroidIcon/>} onClick={()=>router.push("/GlassCase")}>Glass Case</Button>
        <Divider  color="white" />
        <br/><br/>
        <Divider  color="white" />
        <Button startIcon={<PhoneAndroidIcon/>}onClick={()=>router.push("/SublimationPhoneCase")}>Sublimation Phone <br></br> Case</Button>
        <Divider  color="white"/>
        <br/><br/>
        <Divider  color="white" />
        <Button startIcon={<MasksIcon/>}onClick={()=>router.push("/FaceMask")}>Face Mask</Button>
        <Divider  color="white"/>
        <br/><br/>
        <Divider  color="white" />
        <Button startIcon={<MouseIcon/>}onClick={()=>router.push("/MousePad")}>Mouse Pad</Button>
        <Divider  color="white"/>
        <br/><br/>
        <Divider  color="white" />
        <Button onClick={()=>router.push("/")}>T-Shirt</Button>
        <Divider  color="white"/>
        <br/><br/><br></br>
        <Divider  color="white" />
